...
class hauptpage:
    ...
    def _create_daschboard(self):
        ...
        self.left_frame = ctk.CTkFrame(self.daschboar, corner_radius=0, border_width=1, fg_color="#99c0b3")
        self.left_frame.pack(fill="both", side="left")

        # right frame for all tab and specifics information 
        self.right_frame = ctk.CTkFrame(self.daschboar, fg_color="#99c0b3", corner_radius=0)
    ...
    def _set_frame_width(self):
        ...
        self.left_frame.configure(width=width_l)
        self.right_frame.configure(width=width_r)
    ...
    def _widget_dash(self):
        ...
        self.welcome_label = ctk.CTkLabel(self.custom_frame, text=f"Willkommen zurück, {self.uservar.get()}!", text_color=self.color, font=("PT serif", 35))
